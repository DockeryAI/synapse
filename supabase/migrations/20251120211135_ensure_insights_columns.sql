-- Ensure onboarding insights columns exist in brands table
-- This migration re-applies the schema changes to fix missing columns
-- Created: 2025-11-20
...
-- Add indexes for JSON queries (safe with IF NOT EXISTS)
