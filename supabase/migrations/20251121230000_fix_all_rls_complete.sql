-- ============================================================================
-- FIX ALL RLS POLICIES - COMPLETE FIX INCLUDING INDUSTRY_PROFILES
-- ============================================================================
-- This migration fixes ALL RLS policy errors blocking dashboard and onboarding
-- Date: 2025-11-21
-- ============================================================================
...
-- ============================================================================
-- 4. FIX industry_profiles (406 errors)
-- ============================================================================
DROP POLICY IF EXISTS "Users can view industry profiles" ON public.industry_profiles;
DROP POLICY IF EXISTS "Users can create industry profiles" ON public.industry_profiles;
DROP POLICY IF EXISTS "Users can update industry profiles" ON public.industry_profiles;
DROP POLICY IF EXISTS "Allow reading industry profiles" ON public.industry_profiles;
DROP POLICY IF EXISTS "Allow creating industry profiles" ON public.industry_profiles;
DROP POLICY IF EXISTS "Allow updating industry profiles" ON public.industry_profiles;
...
BEGIN
  ...
  RAISE NOTICE '   - industry_profiles: Open access';
END $$;
