...
export interface BuyerPersona {
  ...
  validated?: boolean; // Whether the persona was validated by user during UVP flow
}
          ...
          >
            {triggers.map((trigger, index) => (
              <motion.div
                ...
                onClick={() => onValidateTrigger(trigger.id)}
                className="bg-white dark:bg-slate-800 rounded-xl border-2 border-gray-200 dark:border-slate-700 p-6 cursor-pointer hover:border-blue-400 dark:hover:border-blue-500 transition-colors"
              >
          ...
          >
            {personas.map((persona, index) => (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: index * 0.1 }}
                onClick={() => onValidatePersona(persona.id)}
                className="bg-white dark:bg-slate-800 rounded-xl border-2 border-gray-200 dark:border-slate-700 p-6 space-y-4 cursor-pointer hover:border-blue-400 dark:hover:border-blue-500 transition-colors"
              >
                <div>
