...
DROP FUNCTION IF EXISTS public.insert_location_cache CASCADE;
DROP FUNCTION IF EXISTS public.get_location_cache CASCADE;
...
DROP POLICY IF EXISTS "public_read_cache" ON location_detection_cache;
...
BEGIN
  ...
  RAISE NOTICE '2. Test the UVP flow - should work without 400 errors!';
END $$;